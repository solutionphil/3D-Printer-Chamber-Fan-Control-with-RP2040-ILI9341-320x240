...
TFT_eSprite sliderSprite = TFT_eSprite(&tft); // Create sprite for slider background
...
void setup() {
  ...
  sliderSprite.setColorDepth(8);
  sliderSprite.createSprite(240, 320);  // Full screen sprite
